...
## 2. Inicialização dos robôs (init_map)
...
## 6. Evaporação do feromônio (pheromone_robot_evaporate e global_pheromone_evaporate)
...
# Visualização (view_phetomone_map)
...
-> AQUI TUDO É CENTRALIZADO, TUDO RODA EM CIMA DE UM MAPA CENTRAL E DO MAPA CENTRAL PARA OS ROBOS
